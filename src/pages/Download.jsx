...
const Download = () => {
  ...
  useEffect(() => {
    toast.success("1 file found, please download.");
  }, []);
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      console.error(error);
      toast.error(
        "Failed to download file. Please try again or ask the uploader to re-upload."
      );
      setStatus("error");
    }
  };
        ...
        >
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-2">
            {status === "error"
              ...
              : "SECURE_PACKAGE_DETECTED"}
          </h1>

          <p className="font-mono text-sm opacity-60 mb-8">
            {status === "idle" &&
              "CAUTION: FILE WILL SELF-DESTRUCT AFTER DOWNLOAD"}
